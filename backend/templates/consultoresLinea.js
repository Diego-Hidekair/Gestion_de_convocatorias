...
<h1 class="centrado bold">
  ${convocatoria.etapa_convocatoria} CONVOCATORIA A CONCURSO DE MÉRITOS Y EXÁMENES DE COMPETENCIA PARA LA PROVISIÓN DE DOCENTE CONSULTORES DE LÍNEA  PARA LA CARRERA DE ${convocatoria.programa} - GESTIÓN ${anioFin}
</h1>

<p>
  En aplicación de la Nota de Instrucción N° 001/2023 y N° 043/2023 emitidas por el Señor Rector de la Universidad, y por Dictamen de la Comisión Académica N° 10/2023 homologado por la Resolución del Honorable Consejo Universitario N° 09/2024 y cumpliendo con la normativa universitaria se convoca a los profesionales <strong>${convocatoria.perfil_profesional}</strong>, a la <strong>${convocatoria.etapa_convocatoria} CONVOCATORIA DE MÉRITOS Y EXÁMENES DE COMPETENCIA</strong> para optar por la docencia universitaria en la categoría de <strong>Docente CONSULTORES DE LÍNEA </strong> en aplicación del Art. 70 del Reglamento del Régimen Académico Docente de la Universidad Boliviana, ingresando el ganador como docente Contratado, conforme lo dispone el Art. 72 del mismo cuerpo normativo, para luego ser sometido a evaluación continua y pasar a la categoría de titular, tal como lo establece el Art. 73 del Reglamento referido, como <strong>Docente Consultores de Línea </strong> en la siguiente asignatura:
</p>

<h3><strong>1. MATERIA OBJETO DE LA ${convocatoria.etapa_convocatoria} CONVOCATORIA:</strong></h3>
<p><strong>DOCENTES Consultores de Línea </strong></p>
...
Provisión de Docente  Consultores de Línea para la Carrera de ${convocatoria.programa}
